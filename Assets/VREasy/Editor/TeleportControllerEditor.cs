...
namespace VREasy
{
    ...
    public class TeleportControllerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            float reach = EditorGUILayout.Slider("Parabole reach", teleport.reach, 1.0f, 4.0f);
            float maxStepDown = Mathf.Clamp(EditorGUILayout.FloatField("Max step down", teleport.maxStepDown), 5f,Mathf.Infinity);
