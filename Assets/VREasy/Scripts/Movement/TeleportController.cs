...
namespace VREasy
{
    ...
    public class TeleportController : MonoBehaviour
    {
        ...
        public float reach = 1.0f; // valid values between 1 and 4
        ...
        private bool createAndDetectParabole()
        {
            ...
            float angle = Mathf.Clamp(360 - transform.eulerAngles.x,0f,45f);
        ...
        public bool StartTrajectory(float v, float angle) {
            ...
            do {
                ...
                switch(type)
                {
                    case TELEPORT_CONTROLLER_RENDERER.LINE:
                        ...
                        break;
                    case TELEPORT_CONTROLLER_RENDERER.TEXTURES:
                        positions.Add(transform.InverseTransformPoint(currentPoint));
                        break;
                }
            ...
            } while(y > transform.position.y - maxStepDown);//while(count <= maxLength);
