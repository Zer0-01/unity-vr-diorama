    ...
    public class LoadSceneAction : VRAction
    {
        ...
        public override void Trigger()
        {
            ...
            if (useCustomParameters)
                _loadSceneManager.LoadScene(sceneToLoad, rememberLastLocation, Player, hasFuturePosition, futurePosition, timeToLoad, doFadeOut);
            else
                _loadSceneManager.LoadScene(sceneToLoad, rememberLastLocation, Player, hasFuturePosition, futurePosition);
        }
